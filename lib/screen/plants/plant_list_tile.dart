...
import 'package:garden_control/screen/plants/readings_page.dart';
...
class PlantListTile extends HookWidget {
  final Plant plant;
  PlantListTile({super.key, required this.plant});
  final StorageService storageService = PlantService.storageService;
  ...
  void _navigateToSensor(BuildContext context, ImageProvider image) {
    Navigator.push(
        context,
        PageRouteBuilder(
            pageBuilder: (q, w, e) => ReadingPage(plant: plant, image: image),
            transitionsBuilder:
